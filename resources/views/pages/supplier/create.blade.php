...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Input Supplier</h1>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('supplier.store_supplier') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="sales_name" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">No Handphone Sales</label>
                                    <input class="form-control" name="sales_phone" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
